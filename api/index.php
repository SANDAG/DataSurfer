...
$app->get('/census/:year/:geotype/:zone/transportation', function ($year, $geotype, $zone) use ($app)
{
    $datasource_id = Query::getInstance()->getDatasourceId('census', $year);
...
$app->get('/census/:year/:geotype/:zone/employmentstatus', function ($year, $geotype, $zone) use ($app)
{
    $datasource_id = Query::getInstance()->getDatasourceId('census', $year);
...
$app->get('/census/:year/:geotype/:zone/povertystatus', function ($year, $geotype, $zone) use ($app)
{
    $datasource_id = Query::getInstance()->getDatasourceId('census', $year);
...
$app->get('/census/:year/:geotype/:zone/education', function ($year, $geotype, $zone) use ($app)
    {
        $datasource_id = Query::getInstance()->getDatasourceId('census', $year);
...
//Census - Language Spoken
$app->get('/census/:year/:geotype/:zone/language', function ($year, $geotype, $zone) use ($app)
    {
        $datasource_id = Query::getInstance()->getDatasourceId('census', $year);
